...
function sendEmail() {
    ...
    Email.send({
        SecureToken : "edd8ce25-f22b-48f5-be86-c41c9571e697",
        To: 'pidhrabiawork@gmail.com',
        ReplyFrom : document.getElementById("email").value,
        From : 'pidhrabia@gmail.com',
...
window.addEventListener("load", () => {
    ...
    footerText.innerHTML = `Copyright &copy; ${currentYear} by Pidhrabia | All Right Reserved.`;
});
